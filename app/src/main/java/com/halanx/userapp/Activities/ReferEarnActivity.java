...
//        });
  ...
  //      referal.setText(user.getMyreferalCode());
        ...
        Volley.newRequestQueue(getApplicationContext()).add(new JsonObjectRequest(Request.Method.GET, djangoBaseUrl +"users/detail/", jsonObject, new Response.Listener<JSONObject>() {
            @Override
   ...
   */
        ...
        String shareBody = "Get grocery and food delivered from your favorite Stores and " +
                ...
                "https://play.google.com/store/apps/details?id=com.halanx.userapp " +"with my referral code " + referal.getText()+" and get ₹ 50 H-Cash" ;
